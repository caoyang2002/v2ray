...
<h2 id="sing-box脚本-推荐">sing-box脚本(推荐)</h2>

<p>备注，推荐使用 sing-box 脚本，支持更多协议，如 REALITY，TUIC，Trojan，Hysteria2 等协议</p>

<p>请看：<a href="https://github.com/233boy/sing-box/wiki/sing-box一键安装脚本" target="_blank">sing-box一键安装脚本</a></p>

<p>你完全可以使用 sing-box 脚本来代替 v2ray 脚本使用。</p>
...
<p>请看：<a href="https://233boy.com/v2ray/v2ray-dns/">V2Ray 脚本 DNS 设置</a></p>
